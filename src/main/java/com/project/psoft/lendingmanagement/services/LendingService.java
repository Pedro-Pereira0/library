...
import com.project.psoft.lendingmanagement.model.metrics.*;
import com.project.psoft.bookmanagement.repositories.BookRepository;
import com.project.psoft.exceptions.BadRequestException;
...
import com.project.psoft.lendingmanagement.model.metrics.answerDB.LendingAvgPerBookDB;
import com.project.psoft.lendingmanagement.model.metrics.averages.*;
import com.project.psoft.lendingmanagement.model.metrics.answerDB.LendingAvgPerMonthAndGenreDB;
import com.project.psoft.lendingmanagement.model.metrics.answerDB.LendingCountPerGenreDB;
import com.project.psoft.lendingmanagement.model.metrics.answerDB.LendingReportDB;
import com.project.psoft.lendingmanagement.repositories.LendingRepository;
import com.project.psoft.lendingmanagement.services.requests.CreateLendingRequest;
import com.project.psoft.lendingmanagement.services.requests.ReturnBookRequest;
import com.project.psoft.lendingmanagement.utils.MonthValidator;
import com.project.psoft.lendingmanagement.utils.Unit;
import com.project.psoft.lendingmanagement.utils.YearValidator;
...
public class LendingService {
    ...
    public List<ReportMonthlyLendingPerReader> getMonthlyLendingPerReader(LocalDate startDate, LocalDate endDate, com.project.psoft.readermanagement.services.Page page){
        if (page == null) {
            page = new com.project.psoft.readermanagement.services.Page(1, 5);
        }
